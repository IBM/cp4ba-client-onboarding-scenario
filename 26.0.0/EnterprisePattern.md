# Deploying the Client Onboarding scenario an Enterprise Pattern Deployment Environment (for CP4BA 26.0.0)

## Introduction

To deploy the Client Onboarding scenario to a Cloud Pak for Business Automation (CP4BA) 26.0.0 **Enterprise** Deployment environment is supported for various types of Enterprise pattern configurations.
