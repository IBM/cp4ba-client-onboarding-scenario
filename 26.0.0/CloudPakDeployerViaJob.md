# Deploying the Client Onboarding scenario into an Enterprise Deployment created by Cloud Pak Deployer - Using an OCP Job (for CP4BA 26.0.0) 
...
3. **Import** the following **YAML** to **create a Service Account** and **assign** it the **required rights** 
   ...
   >
   > 1. Once logged into the OpenShift console, **click** the **+** sign in the top right corner and **select Import YAML**.
   >
