...
echo.
SETLOCAL
rem This file is to be used with an arbitrary CP4BA 24.0.1 Enterprise deployment with a co-deployed gitea to deploy the Client Onboarding scenario and associated labs (by default using an  external mail server)
