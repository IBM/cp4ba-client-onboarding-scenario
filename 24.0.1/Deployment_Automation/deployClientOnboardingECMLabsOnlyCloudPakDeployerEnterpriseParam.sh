...
# This file is to be used with CP4BA 24.0.1 Enterprise deployment that was deployed using 
# either Apollo-One-Shot or Cloud Pak Deployer approach to only deploy the ECM labs of the 
...
COPYVARVALUES=ocLoginServer,ocLoginToken,cp4baNamespace,createUsers,useInternalMailServer,ocpStorageClassForInternalMailServer,gmailAddress,gmailAppKey,dockerUserName,dockerToken,jvmSettings,disableAccessToGitHub,proxyScenario,proxyHost,proxyPort,proxyUser,proxyPwd,proxyPwd,bootstrapDebugString,outputPath,printDetailedMessageToConsole,printTraceMessageToConsole
