# Deploying the Client Onboarding scenario into a Starter deployment environment - Using an OCP Job (for CP4BA 24.0.1) 
...
**Cloud Pak for Business Automation (CP4BA) 24.0.1 Starter deployment environment**
