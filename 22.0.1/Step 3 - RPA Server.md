...
6. Click the **Desktop Access link** above to open your environment. When you are prompted to enter environment password, enter the desktop password above. Click the triangle icon to start the environment and wait a few minutes, your environment will be ready as below.  
