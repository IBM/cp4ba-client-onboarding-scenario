# Deploying the Client Onboarding scenario on an Enterprise Deployment with Rapid Deployment LDAP and co-deployed Gitea (for CP4BA 25.0.0)

## Introduction

These instructions apply in case you have set up your CP4BA 25.0.0 Enterprise deployment 
...
### Download Required bat/sh File
   ...
   2. **Save the deployment file** that corresponds to the operating system of your deployment machine into the directory created in step 1 (in the context menu of your browser select **Save as.../Save page as...** or similar)
      ...
      **Linux/Mac** - *CP4BA 25.0.0* - Enterprise deployment - **[deploy](https://raw.githubusercontent.com/IBM/cp4ba-client-onboarding-scenario/main/25.0.0/Deployment_Automation/deployClientOnboardingRapidDeploymentEnterpriseWithGitea.sh)** (*Ensure to make the sh file executable by performing `chmod +x deployClientOnboardingRapidDeploymentEnterpriseWithGitea.sh`*)

      **Windows** - *CP4BA 25.0.0* - Enterprise deployment - **[deploy](https://raw.githubusercontent.com/IBM/cp4ba-client-onboarding-scenario/main/25.0.0/Deployment_Automation/deployClientOnboardingRapidDeploymentEnterpriseWithGitea.bat)**
...
- deployClientOnboarding_25.0.0_Enterprise_output.txt - Contains the messages printed to the console
- deployClientOnboarding_25.0.0_Enterprise_detailedOutput.txt - Everything printed to the console plus details about the deployment steps
- deployClientOnboarding_25.0.0_Enterprise_trace.txt - Contains very detailed trace messages about everything that is done as part of running a deployment
- deployClientOnboarding_25.0.0_Enterprise_combined.txt - Contains a combination of the detailedOutput and trace files
...
1. Clone the git repository or alternatively download the [Enterprise](https://github.com/IBM/cp4ba-client-onboarding-scenario/tree/main/25.0.0/Deployment_Automation/Enterprise) folder, [Solution Exports](https://github.com/IBM/cp4ba-client-onboarding-scenario/tree/main/25.0.0/Solution%20Exports) folder, and the [«date»_DeploymentAutomation.jar](https://github.com/IBM/cp4ba-client-onboarding-scenario/tree/main/Deployment_Automation/Current) file
...
1. **Save the undeployment file** that corresponds to the operating system of your deployment machine into the directory created in step 1 (in the context menu of your browser select **Save as.../Save page as...** or similar)
   ...
   **Linux/Mac** - *CP4BA 25.0.0* - Enterprise deployment - **[undeploy](https://raw.githubusercontent.com/IBM/cp4ba-client-onboarding-scenario/main/25.0.0/Deployment_Automation/undeployClientOnboardingRapidDeploymentEnterpriseWithGitea.sh)** (*Ensure to make the sh file executable by performing `chmod +x undeployClientOnboardingRapidDeploymentEnterpriseWithGitea.sh`*)

   **Windows** - *CP4BA 25.0.0* - Enterprise deployment - **[undeploy](https://raw.githubusercontent.com/IBM/cp4ba-client-onboarding-scenario/main/25.0.0/Deployment_Automation/undeployClientOnboardingRapidDeploymentEnterpriseWithGitea.bat)**

2. On Windows open the file **undeployClientOnboardingRapidDeploymentEnterpriseWithGitea.bat**/on Linux or Mac open the file **undeployClientOnboardingRapidDeploymentEnterpriseWithGitea.sh** in the text editor of your choice. 
