...
These instructions apply for those cases where you have an LDAP with arbitrary users and groups and want to use an external Git repository on github.com for your CP4BA 25.0.0 Enterprise deployment. It is the most flexible deployment profile but therefore also requires the highest amount of configuration parameters to be specified.
...
1. **Save the undeployment file** that corresponds to the operating system of your deployment machine into the directory created in step 1 (in the context menu of your browser select **Save as.../Save page as...** or similar)
   ...
   **Linux/Mac** - *CP4BA 25.0.0* - Enterprise deployment - **[undeploy](https://raw.githubusercontent.com/IBM/cp4ba-client-onboarding-scenario/main/25.0.0/Deployment_Automation/undeployClientOnboardingEnterpriseExternalGit.sh)** (*Ensure to make the sh file executable by performing `chmod +x undeployClientOnboardingRapidDeploymentEnterpriseWithGitea.sh`*)

   **Windows** - *CP4BA 25.0.0* - Enterprise deployment - **[undeploy](https://raw.githubusercontent.com/IBM/cp4ba-client-onboarding-scenario/main/25.0.0/Deployment_Automation/undeployClientOnboardingEnterpriseExternalGit.bat)**
