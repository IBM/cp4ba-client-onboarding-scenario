...
echo.
SETLOCAL
rem This file is to be used with CP4BA 25.0.1 starter deployment to deploy the an email server/client
...
SET COPYVARVALUES=ocLoginServer,ocLoginToken,ocpStorageClassForInternalMailServer,createUsers,dockerUserName,dockerToken,jvmSettings,disableAccessToGitHub,proxyScenario,proxyHost,proxyPort,proxyUser,proxyPwd,proxyPwd,bootstrapDebugString
