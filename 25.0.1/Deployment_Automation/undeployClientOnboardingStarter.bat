...
echo.
SETLOCAL
rem This file is to be used with CP4BA 25.0.1 starter deployment to remove the Client Onboarding scenario and associated labs
...
SET COPYVARVALUES=ocLoginServer,ocLoginToken,cleanupClientOnboardingLabs_UserData,cleanupClientOnboardingLabs,cleanupClientOnboardingScenario,disableAccessToGitHub,proxyScenario,proxyHost,proxyPort,proxyUser,proxyPwd,proxyPwd,bootstrapDebugString
